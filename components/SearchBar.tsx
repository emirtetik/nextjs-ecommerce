...
const SearchBar = () => {
  ...
  const router = useRouter()
    const handleSearch = (e:React.FormEvent<HTMLFormElement>) => {
              ...
              if(manufacturer === "" && model === ""){
                return alert('Lütfen arama çubuğunu doldurun')
              }
  ...
  return (
    <form  className='searchbar' onSubmit={handleSearch}>
         ...
         <input type="text" name='model' value={model} onChange={(e) => setModel(e.target.value)} placeholder='Wagon' className='searchbar__input'/>
         <SearchButton otherClass='sm:hidden'/>
         </div>
